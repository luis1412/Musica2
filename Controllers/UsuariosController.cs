...
namespace Musica2.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id, nombreUsuario, DatosBancarios, CancionesUsuarios")]
Usuarios estudiante)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id,
       [Bind("Id, nombreUsuario, DatosBancarios, CancionesUsuarios")] Usuarios estudiante)
        {
            if (id != estudiante.Id)
            {
                return NotFound();
